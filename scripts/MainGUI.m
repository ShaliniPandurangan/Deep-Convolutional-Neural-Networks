...
while LIST~=Possibility
LIST=menu('MEDICAL IMAGE PROCESSING','IMAGE ACQUISITION','IMAGE DENOISING','IMAGE ENHANCEMENT','IMAGE SEGMENTATION','SUPER IMPOSE','FEATURE EXTRACTION','CLOSE');
if LIST==1
% IMAGE ACQUISITION
